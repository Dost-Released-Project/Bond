...
//     version 1.18.0
//     from Assets/98. LeeJuno/Juno_Test.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/98. LeeJuno/Juno_Test.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Juno_Test: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@Juno_Test()
    {
        UnityEngine.Debug.Assert(!m_Space.enabled, "This will cause a leak and performance issues, Juno_Test.Space.Disable() has not been called.");
    }
    ...
    {
        private @Juno_Test m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public SpaceActions(@Juno_Test wrapper) { m_Wrapper = wrapper; }
        /// <summary>

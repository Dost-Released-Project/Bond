...
/// <summary>
/// MapInitializer 에서 로드한 배경 Sprite 를 전투씬 BattleBgLoader 로 전달하는 단방향 정적 채널.
///
...
///   2. BattleBgLoader.Start() → Get() 으로 Sprite 수신 후 Image 에 적용
///   3. MapInitializer.Dispose() → Clear() 호출 (핸들 해제와 함께 수행)
/// </summary>
public static class BattleMapBgChannel
{

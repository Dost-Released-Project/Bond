...
{
    public class TutorialEntryPoint : IInitializable
    {
        private readonly TutorialSystemController _tutorialController;

        [Inject]
        public TutorialEntryPoint(TutorialSystemController tutorialController)
        {
        ...
        public void Initialize()
        {
            ...
            var queryResult = DBSORegistry.QuerySO<TutorialStepSO>(so => so.Sequence == TutorialSequence.Sequence_A_Town);

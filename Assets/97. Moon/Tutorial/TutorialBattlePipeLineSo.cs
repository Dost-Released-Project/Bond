...
namespace PipeLine
{
    ...
    [System.Serializable]
    public class TutorialEntryStep : IPipeLineStep<BattleContext>
    {
    ...
    [System.Serializable]
    public class TutorialEvasionStep : IPipeLineStep<BattleContext>
    {
        public UniTask<BattleContext> Execute(BattleContext context)
        {
    ...
    [System.Serializable]
    public class TutorialCriticalStep : IPipeLineStep<BattleContext>
    {
    ...
    [System.Serializable]
    public class TutorialDefenseStep : IPipeLineStep<BattleContext>
    {
        public UniTask<BattleContext> Execute(BattleContext context)
        {
            if (context.isEvaded || context.target == null || context.target.IsDead) return UniTask.FromResult(context);
    ...
    [System.Serializable]
    public class TutorialReactionCall : IPipeLineStep<BattleContext>
    {
    ...
    [System.Serializable]
    public class TutorialApplyStep : IPipeLineStep<BattleContext>
    {
        public UniTask<BattleContext> Execute(BattleContext context)
        {

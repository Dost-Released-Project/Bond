...
{
    public class BattleTutorialEntryPoint : IInitializable
    {
        private readonly BattleTutorialSystemController _tutorialController;

        [Inject]
        public BattleTutorialEntryPoint(BattleTutorialSystemController tutorialController)
        {
        ...
        public void Initialize()
        {
            ...
            var queryResult = DBSORegistry.QuerySO<TutorialStepSO>(so => so.Sequence == TutorialSequence.Sequence_D_Battle);

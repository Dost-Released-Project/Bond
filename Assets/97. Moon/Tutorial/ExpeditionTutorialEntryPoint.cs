...
{
    public class ExpeditionTutorialEntryPoint : IInitializable
    {
        private readonly ExpeditionTutorialSystemController _tutorialController;

        [Inject]
        public ExpeditionTutorialEntryPoint(ExpeditionTutorialSystemController tutorialController)
        {
